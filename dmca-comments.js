...
var rebuttals = [{'index': '1', 'rebuttal_text': 'Several of the opponents of the exemption for college and university professors and students (both in traditional classes and in online courses) argued that screen capture technology has become so cheap, and attained such high quality, that it can be used for virtually any purpose. Have you tried to use screen capture software, like Greenshot, VLC, Snagit, Camtasia, Movavi, Camstudio, Jing and WM Capture? If so, have you run into difficulties or limitations of that software? <br> <br> Opponents of this exemption also suggest that streaming services like Netflix, Flixster, anyclip.com, or the Movieclips YouTube channel provide alternatives to ripping DVDs or Blu-ray discs for educational purposes. Have you tried to use these services? What limitations or difficulties have you encountered?'},
   ...
   {'index': '8', 'rebuttal_text': 'The DVD ripping exemption will allow DVD owners to continue to be able to access and enjoy the copies of the works they have bought, even as the formats in which they purchased them become increasingly obsolete.  <br><br> Millions of people have ripped CDs. Making a copy of media you own so you can access it on another device seems like an obvious fair use. So why should ripping a movie for your own use be any different? Courts have established this right with respect to music CDs, and DVDs and Blue-ray Discs should\'t be different <br><br> Opponents of the exemption say DVD owners should buy everything again in digital formats. Individuals who have purchased DVDs should be able to keep the content they own, even as technology inevitably advances and current formats become obsolete. It is unreasonable to expert DVD owners to simply replace all their current DVD library with digital purchases, and some of this content is not available digitally.  <br><br> Opponents also disregard the fact that users don\'t always have access to wireless Internet. But you can’t always find your content on a service like Netflix when you have a slow Internet connection or are without an Internet connection completely, such as when you are traveling.  <br><br> Tell the Copyright Office how much it would cost you to replace your DVD and Blue-ray collection with digital purchases on iTunes.  <br><br> Tell the Copyright Office the problems you will face using your DVDs and Blue-rays with newer devices if DVD and Blue-ray drives become obsolete.  <br><br> Tell the Copyright Office why you shouldn\'t have to re-buy DVDs and Blue-rays you have already paid for in a different format, or record the DVD or Blue-ray content with a camera, or purchase an external drive.  <br><br> Tell the Copyright Office that this exemption would allow you to watch your movies when you\'re offline.'},
...
var rebuttal_indexes = ['1', '3', '8', '11', '21', '23', '26'];
var Collections = {};
var Schemas = {};
