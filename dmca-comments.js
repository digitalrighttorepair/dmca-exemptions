...
var abandoned_products_exemptions = [
   ...
   Template.exemptionsForm.helpers({
      ...
      exemption_requests: function() {
         return [
            {'exemption': {
                  'name': 'Multimedia',
                  'list': multimedia_exemptions
               },
            },
            {'exemption': {
                  'name': 'Literary Works',
                  'list': literary_exemptions
               },
            },
            {'exemption': {
                  'name': 'Unlocking',
                  'list': unlocking_exemptions
               },
            },
            {'exemption': {
                  'name': 'Jailbreaking',
                  'list': jailbreaking_exemptions
               },
            },
            {'exemption': {
                  'name': 'Vehicle & Farm Equipment',
                  'list': vehicle_exemptions
               },
            },
            {'exemption': {
                  'name': 'Security Research',
                  'list': security_exemptions
               },
            },
            {'exemption': {
                  'name': 'Abandoned Products',
                  'list': abandoned_products_exemptions
               },
            },
            {'exemption': {
                  'name': 'Miscellaneous',
                  'list': misc_exemptions
               },
            }
         ];
      }
