...
if (Meteor.isClient) {
   ...
   Template.exemptionsForm.helpers({
      ...
      exemption_requests: function() {
         ...
         var columns = 3;
         return [
            {'exemption' : exemption_requests.slice(0, len / columns)},
            {'exemption' : exemption_requests.slice(len / columns, len / columns * 2)},
            {'exemption' : exemption_requests.slice(len / columns * 2, len)}
         ];
      }
   });
